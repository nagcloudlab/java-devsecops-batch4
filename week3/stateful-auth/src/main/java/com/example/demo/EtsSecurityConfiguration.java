...
public class EtsSecurityConfiguration {
    ...
    // @Bean
    // public AuthenticationManagerBuilder authenticationManagerBuilder(HttpSecurity
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
            AuthorizationManager<RequestAuthorizationContext> customAuthz) throws Exception {
        http
                ...
                .addFilterBefore(etsAuthenticationFilter(authenticationManager(http)),
